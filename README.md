...
![FM-Synthesis Waveform Visualizer for Webのスクリーンショット](./assets/images/readme-screenshot-v2.0.0.png)

## GitHub Pages

[https://igarin14pm.github.io/fm-synthesis-waveform-visualizer-web/](https://igarin14pm.github.io/fm-synthesis-waveform-visualizer-web/)
...
- Safari 26.3.1
- Google Chrome 145.0.7632.160 (arm64)
...
ローカルで動かしたい場合は、Releasesから最新のバージョンをダウンロードしてPCの任意のディレクトリ(ドキュメントフォルダなど)内に配置し、その中の`index.html`をブラウザで開いてください。
